...
public class DownloadManager {
    ...
    private DownloadInfo getRealFileName(DownloadInfo downloadInfo) {
        ...
        Log.e("flag", "---------getRealFileName url:" + downloadInfo.getUrl() + "--name:" + getTemporaryName(downloadInfo.getUrl()));
        File file = new File(getTemporaryName(downloadInfo.getUrl()));
        if (file.exists()) {
            //找到了文件,代表已经下载过,则获取其长度
            downloadLength = file.length();
            Log.e("flag", "---------getRealFileName url length:" + downloadLength);
        }
...
//        }
    ...
    public long getFileLoadLenth(String url) {
        ...
        Log.e("flag", "------------getFileLoadLenth:" + url + "---downloadLength:" + getTemporaryName(url));
